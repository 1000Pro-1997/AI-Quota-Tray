...
public static class Strings
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Table = new()
    {
        ["en"] = new()
        {
            ...
            ["settings.issuesButton"] = "Open",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "Open the project homepage",
            ["settings.githubButton"] = "Open",
            ...
            ["settings.installLauncher"] = "Install launcher",
            ["settings.installingLauncher"] = "Installing launcher…",
            ["settings.autoUpdateNeedsLauncher"] = "Auto-update needs the launcher",
            ...
            ["settings.timeDisplayHint"] = "Format tokens: MM dd hh mm ss · last field is maximum parts",
            ["settings.sessionTime"] = "5-hour",
            ["settings.weeklyTime"] = "Weekly",
            ["settings.widgetPartCount"] = "Widget",
            ["settings.overlayPartCount"] = "Overlay",
            ["settings.timeRemaining"] = "Remaining",
            ["settings.timeResetAt"] = "Reset time",
            ["settings.widgetBar"] = "Widget bar",
            ["settings.widgetBarHint"] = "Show a horizontal bar next to the taskbar",
            ["settings.widgetHideOnFullScreen"] = "Hide while a full-screen app is running",
            ["settings.widgetHideOnFullScreenHint"] = "Step aside like the taskbar does for games and full-screen video",
            ["settings.widgetShowPercent"] = "Show remaining percentage",
            ["settings.widgetShowResetTime"] = "Show reset time",
            ["settings.fontSize"] = "Font size",
            ["settings.widgetAutoSize"] = "Automatic size",
            ["settings.widgetAutoSizeHint"] = "Fit the widget to its contents",
            ["settings.widgetWidth"] = "W",
            ["settings.widgetHeight"] = "H",
            ["settings.widgetOrientation"] = "Horizontal model layout",
            ["settings.widgetOrientationHint"] = "Turn off to stack models vertically",
            ["settings.widgetMonitor"] = "Widget monitor",
            ["settings.widgetMonitorHint"] = "Choose where the widget bar appears",
            ["settings.widgetAutoOffset"] = "Automatic position",
            ["settings.widgetAutoOffsetHint"] = "Turn off to edit the offset values",
            ["settings.widgetOffset"] = "Manual offset",
            ["settings.widgetOffsetHint"] = "Nudge from the automatic position",
            ["settings.widgetOffsetX"] = "Left",
            ["settings.widgetOffsetY"] = "Up",
        ...
        ["ko"] = new()
        {
            ...
            ["settings.issuesButton"] = "바로가기",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "프로젝트 홈페이지 바로가기",
            ["settings.githubButton"] = "바로가기",
            ["settings.installPath"] = "설치 위치",
            ["settings.openFolder"] = "폴더 열기",
            ["settings.launcherFound"] = "런처 준비됨",
            ["settings.launcherMissing"] = "런처 없음",
            ["settings.installLauncher"] = "런처 설치",
            ["settings.installingLauncher"] = "런처를 설치하는 중…",
            ["settings.autoUpdateNeedsLauncher"] = "자동 업데이트에는 런처가 필요합니다",
            ...
            ["settings.timeDisplay"] = "시간 표기 설정",
            ["settings.timeDisplayHint"] = "형식 변수: MM(월) dd(일) hh mm ss · 마지막 칸은 최대 표시 개수",
            ["settings.sessionTime"] = "5시간",
            ["settings.weeklyTime"] = "주간",
            ["settings.widgetPartCount"] = "위젯",
            ["settings.overlayPartCount"] = "오버레이",
            ["settings.timeRemaining"] = "남은 시간",
            ["settings.timeResetAt"] = "초기화 시각",
            ["settings.widgetBar"] = "위젯바",
            ["settings.widgetBarHint"] = "작업표시줄 옆에 가로 막대로 표시",
            ["settings.widgetHideOnFullScreen"] = "전체화면일 때 위젯 숨기기",
            ["settings.widgetHideOnFullScreenHint"] = "게임·전체화면 영상에서 작업표시줄처럼 함께 가려집니다",
            ["settings.widgetShowPercent"] = "남은 % 표시",
            ["settings.widgetShowResetTime"] = "초기화 남은 시간 표시",
            ["settings.fontSize"] = "글자 크기",
            ["settings.widgetAutoSize"] = "위젯 크기 자동 설정",
            ["settings.widgetAutoSizeHint"] = "끄면 가로·세로 크기를 직접 지정합니다",
            ["settings.widgetWidth"] = "가로",
            ["settings.widgetHeight"] = "세로",
            ["settings.widgetOrientation"] = "모델 가로 정렬",
            ["settings.widgetOrientationHint"] = "끄면 모델을 세로로 정렬합니다",
            ["settings.widgetMonitor"] = "위젯 표시 모니터",
            ["settings.widgetMonitorHint"] = "위젯바를 표시할 화면 선택",
            ["settings.widgetAutoOffset"] = "자동 위치",
            ["settings.widgetAutoOffsetHint"] = "끄면 옆의 오프셋 값을 직접 입력합니다",
            ["settings.widgetOffset"] = "수동 오프셋",
            ["settings.widgetOffsetHint"] = "자동 위치에서 밀어낼 거리",
            ["settings.widgetOffsetX"] = "왼쪽",
            ["settings.widgetOffsetY"] = "위",
            ["settings.primaryMonitor"] = "주 모니터",
        ...
        ["ja"] = new()
        {
            ...
            ["settings.issuesButton"] = "開く",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "プロジェクトのホームページを開く",
            ["settings.githubButton"] = "開く",
            ...
            ["settings.installLauncher"] = "ランチャーをインストール",
            ["settings.installingLauncher"] = "ランチャーをインストール中…",
            ["settings.autoUpdateNeedsLauncher"] = "自動更新にはランチャーが必要です",
            ...
            ["settings.widgetHideOnFullScreen"] = "全画面時にウィジェットを隠す",
            ["settings.widgetHideOnFullScreenHint"] = "ゲームや全画面動画ではタスクバーと同じように隠れます",
            ["settings.widgetMonitor"] = "ウィジェットのモニター",
            ["settings.widgetMonitorHint"] = "ウィジェットバーを表示する画面を選択",
            ["settings.widgetAutoOffset"] = "自動配置",
            ["settings.widgetAutoOffsetHint"] = "ウィジェットバーの位置を自動で決めます",
            ["settings.widgetOffset"] = "手動オフセット",
            ["settings.widgetOffsetHint"] = "自動位置からずらす距離",
            ["settings.widgetOffsetX"] = "左",
            ["settings.widgetOffsetY"] = "上",
            ["settings.primaryMonitor"] = "メイン",
        ...
        ["zh-Hans"] = new()
        {
            ...
            ["settings.issuesButton"] = "前往",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "打开项目主页",
            ["settings.githubButton"] = "前往",
            ["settings.installPath"] = "安装位置",
            ["settings.openFolder"] = "打开文件夹",
            ["settings.launcherFound"] = "启动器就绪",
            ["settings.launcherMissing"] = "缺少启动器",
            ["settings.installLauncher"] = "安装启动器",
            ["settings.installingLauncher"] = "正在安装启动器…",
            ["settings.autoUpdateNeedsLauncher"] = "自动更新需要启动器",
            ...
            ["settings.widgetHideOnFullScreen"] = "全屏时隐藏小组件",
            ["settings.widgetHideOnFullScreenHint"] = "游戏或全屏视频时与任务栏一同隐藏",
            ["settings.widgetMonitor"] = "小组件显示器",
            ["settings.widgetMonitorHint"] = "选择小组件栏显示的屏幕",
            ["settings.widgetAutoOffset"] = "自动定位",
            ["settings.widgetAutoOffsetHint"] = "自动确定小组件栏的位置",
            ["settings.widgetOffset"] = "手动偏移",
            ["settings.widgetOffsetHint"] = "相对自动位置的偏移量",
            ["settings.widgetOffsetX"] = "向左",
            ["settings.widgetOffsetY"] = "向上",
        ...
        ["zh-Hant"] = new()
        {
            ...
            ["settings.issuesButton"] = "前往",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "開啟專案首頁",
            ["settings.githubButton"] = "前往",
            ["settings.installPath"] = "安裝位置",
            ["settings.openFolder"] = "開啟資料夾",
            ["settings.launcherFound"] = "啟動器就緒",
            ["settings.launcherMissing"] = "缺少啟動器",
            ["settings.installLauncher"] = "安裝啟動器",
            ["settings.installingLauncher"] = "正在安裝啟動器…",
            ["settings.autoUpdateNeedsLauncher"] = "自動更新需要啟動器",
            ...
            ["settings.widgetHideOnFullScreen"] = "全螢幕時隱藏小工具",
            ["settings.widgetHideOnFullScreenHint"] = "遊戲或全螢幕影片時與工作列一同隱藏",
            ["settings.widgetMonitor"] = "小工具顯示器",
            ["settings.widgetMonitorHint"] = "選擇小工具列顯示的螢幕",
            ["settings.widgetAutoOffset"] = "自動定位",
            ["settings.widgetAutoOffsetHint"] = "自動決定小工具列的位置",
            ["settings.widgetOffset"] = "手動偏移",
            ["settings.widgetOffsetHint"] = "相對自動位置的偏移量",
            ["settings.widgetOffsetX"] = "向左",
            ["settings.widgetOffsetY"] = "向上",
            ["settings.primaryMonitor"] = "主顯示器",
        ...
        ["es"] = new()
        {
            ...
            ["settings.issuesButton"] = "Ir",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "Abrir la página del proyecto",
            ["settings.githubButton"] = "Ir",
            ...
            ["settings.installLauncher"] = "Instalar el lanzador",
            ["settings.installingLauncher"] = "Instalando el lanzador…",
            ["settings.autoUpdateNeedsLauncher"] = "La actualización automática necesita el lanzador",
            ...
            ["settings.widgetHideOnFullScreen"] = "Ocultar en pantalla completa",
            ["settings.widgetHideOnFullScreenHint"] = "Se oculta con la barra de tareas en juegos y vídeo a pantalla completa",
            ["settings.widgetMonitor"] = "Monitor del widget",
            ["settings.widgetMonitorHint"] = "Elegir dónde aparece la barra",
            ["settings.widgetAutoOffset"] = "Posición automática",
            ["settings.widgetAutoOffsetHint"] = "Colocar la barra automáticamente",
            ["settings.widgetOffset"] = "Desplazamiento manual",
            ["settings.widgetOffsetHint"] = "Desplazar desde la posición automática",
            ["settings.widgetOffsetX"] = "Izquierda",
            ["settings.widgetOffsetY"] = "Arriba",
            ["settings.primaryMonitor"] = "Principal",
        ...
        ["pt"] = new()
        {
            ...
            ["settings.issuesButton"] = "Abrir",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "Abrir a página do projeto",
            ["settings.githubButton"] = "Abrir",
            ...
            ["settings.installLauncher"] = "Instalar o inicializador",
            ["settings.installingLauncher"] = "Instalando o inicializador…",
            ["settings.autoUpdateNeedsLauncher"] = "A atualização automática precisa do inicializador",
            ...
            ["settings.widgetHideOnFullScreen"] = "Ocultar em ecrã inteiro",
            ["settings.widgetHideOnFullScreenHint"] = "Oculta-se com a barra de tarefas em jogos e vídeo em ecrã inteiro",
            ["settings.widgetMonitor"] = "Monitor do widget",
            ["settings.widgetMonitorHint"] = "Escolher onde a barra aparece",
            ["settings.widgetAutoOffset"] = "Posição automática",
            ["settings.widgetAutoOffsetHint"] = "Posicionar a barra automaticamente",
            ["settings.widgetOffset"] = "Deslocamento manual",
            ["settings.widgetOffsetHint"] = "Deslocar a partir da posição automática",
            ["settings.widgetOffsetX"] = "Esquerda",
            ["settings.widgetOffsetY"] = "Cima",
            ["settings.primaryMonitor"] = "Principal",
        ...
        ["de"] = new()
        {
            ...
            ["settings.issuesButton"] = "Öffnen",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "Projekt-Homepage öffnen",
            ["settings.githubButton"] = "Öffnen",
            ...
            ["settings.installLauncher"] = "Starter installieren",
            ["settings.installingLauncher"] = "Starter wird installiert…",
            ["settings.autoUpdateNeedsLauncher"] = "Automatische Updates benötigen den Starter",
            ...
            ["settings.widgetHideOnFullScreen"] = "Bei Vollbild ausblenden",
            ["settings.widgetHideOnFullScreenHint"] = "Verschwindet wie die Taskleiste bei Spielen und Vollbildvideos",
            ["settings.widgetMonitor"] = "Widget-Monitor",
            ["settings.widgetMonitorHint"] = "Bildschirm für die Widget-Leiste wählen",
            ["settings.widgetAutoOffset"] = "Automatische Position",
            ["settings.widgetAutoOffsetHint"] = "Widget-Leiste automatisch platzieren",
            ["settings.widgetOffset"] = "Manueller Versatz",
            ["settings.widgetOffsetHint"] = "Von der automatischen Position verschieben",
            ["settings.widgetOffsetX"] = "Links",
            ["settings.widgetOffsetY"] = "Oben",
            ["settings.primaryMonitor"] = "Primär",
        ...
        ["fr"] = new()
        {
            ...
            ["settings.issuesButton"] = "Ouvrir",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "Ouvrir la page du projet",
            ["settings.githubButton"] = "Ouvrir",
            ...
            ["settings.installLauncher"] = "Installer le lanceur",
            ["settings.installingLauncher"] = "Installation du lanceur…",
            ["settings.autoUpdateNeedsLauncher"] = "La mise à jour automatique nécessite le lanceur",
            ...
            ["settings.widgetHideOnFullScreen"] = "Masquer en plein écran",
            ["settings.widgetHideOnFullScreenHint"] = "Se masque avec la barre des tâches pour les jeux et la vidéo plein écran",
            ["settings.widgetMonitor"] = "Écran du widget",
            ["settings.widgetMonitorHint"] = "Choisir où afficher la barre widget",
            ["settings.widgetAutoOffset"] = "Position automatique",
            ["settings.widgetAutoOffsetHint"] = "Placer la barre widget automatiquement",
            ["settings.widgetOffset"] = "Décalage manuel",
            ["settings.widgetOffsetHint"] = "Décaler depuis la position automatique",
            ["settings.widgetOffsetX"] = "Gauche",
            ["settings.widgetOffsetY"] = "Haut",
            ["settings.primaryMonitor"] = "Principal",
        ...
        ["ru"] = new()
        {
            ...
            ["settings.issuesButton"] = "Открыть",
            ["settings.github"] = "GitHub",
            ["settings.githubHint"] = "Открыть страницу проекта",
            ["settings.githubButton"] = "Открыть",
            ...
            ["settings.installLauncher"] = "Установить лаунчер",
            ["settings.installingLauncher"] = "Установка лаунчера…",
            ["settings.autoUpdateNeedsLauncher"] = "Для автообновления нужен лаунчер",
            ...
            ["settings.widgetHideOnFullScreen"] = "Скрывать в полноэкранном режиме",
            ["settings.widgetHideOnFullScreenHint"] = "Прячется вместе с панелью задач в играх и полноэкранном видео",
            ["settings.widgetMonitor"] = "Монитор виджета",
            ["settings.widgetMonitorHint"] = "Выберите экран для панели виджета",
            ["settings.widgetAutoOffset"] = "Автоматическое положение",
            ["settings.widgetAutoOffsetHint"] = "Размещать панель виджета автоматически",
            ["settings.widgetOffset"] = "Ручное смещение",
            ["settings.widgetOffsetHint"] = "Сдвиг от автоматического положения",
            ["settings.widgetOffsetX"] = "Влево",
            ["settings.widgetOffsetY"] = "Вверх",
            ["settings.primaryMonitor"] = "Основной",
